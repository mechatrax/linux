...
#define __AD7793_CHANNEL_WITH_CALIB(_si, _channel1, _channel2, _address, \
	_bits, _storagebits, _shift, _extend_name, _type, \
	_mask_type_av, _mask_all) \
	{ \
		.type = (_type), \
		.differential = (_channel2 == -1 ? 0 : 1), \
		.indexed = 1, \
...
#define AD7793_DIFF_CHANNEL_WITH_CALIB(_si, _channel1, _channel2, _address, \
	_bits, _storagebits, _shift) \
	__AD7793_CHANNEL_WITH_CALIB(_si, _channel1, _channel2, _address, \
		_bits, _storagebits, _shift, NULL, IIO_VOLTAGE, \
		BIT(IIO_CHAN_INFO_SCALE), \
		BIT(IIO_CHAN_INFO_SAMP_FREQ))

#define AD7793_CHANNEL_WITH_CALIB(_si, _channel, _address, \
	_bits, _storagebits, _shift) \
	__AD7793_CHANNEL_WITH_CALIB(_si, _channel, -1, _address, \
		_bits, _storagebits, _shift, NULL, IIO_VOLTAGE, \
		BIT(IIO_CHAN_INFO_SCALE), \
		BIT(IIO_CHAN_INFO_SAMP_FREQ))
...
const struct iio_chan_spec _name##_channels_with_calib[] = { \
	AD7793_DIFF_CHANNEL_WITH_CALIB(0, 0, 0, AD7793_CH_AIN1P_AIN1M, \
		(_b), (_sb), (_s)), \
	AD7793_DIFF_CHANNEL_WITH_CALIB(1, 1, 1, AD7793_CH_AIN2P_AIN2M, \
		(_b), (_sb), (_s)), \
	AD7793_DIFF_CHANNEL_WITH_CALIB(2, 2, 2, AD7793_CH_AIN3P_AIN3M, \
		(_b), (_sb), (_s)), \
	AD7793_SHORTED_CHANNEL(3, 0, AD7793_CH_AIN1M_AIN1M, (_b), (_sb), (_s)), \
	AD7793_TEMP_CHANNEL(4, AD7793_CH_TEMP, (_b), (_sb), (_s)), \
	AD7793_SUPPLY_CHANNEL(5, 3, AD7793_CH_AVDD_MONITOR, (_b), (_sb), (_s)), \
...
const struct iio_chan_spec _name##_channels_with_calib[] = { \
	...
	AD7793_DIFF_CHANNEL_WITH_CALIB(2, 2, 2, AD7793_CH_AIN3P_AIN3M, \
		(_b), (_sb), 0), \
	AD7793_DIFF_CHANNEL_WITH_CALIB(3, 3, 3, AD7795_CH_AIN4P_AIN4M, \
		(_b), (_sb), 0), \
	AD7793_DIFF_CHANNEL_WITH_CALIB(4, 4, 4, AD7795_CH_AIN5P_AIN5M, \
		(_b), (_sb), 0), \
	AD7793_DIFF_CHANNEL_WITH_CALIB(5, 5, 5, AD7795_CH_AIN6P_AIN6M, \
		(_b), (_sb), 0), \
	AD7793_SHORTED_CHANNEL(6, 0, AD7795_CH_AIN1M_AIN1M, (_b), (_sb), 0), \
	AD7793_TEMP_CHANNEL(7, AD7793_CH_TEMP, (_b), (_sb), 0), \
	AD7793_SUPPLY_CHANNEL(8, 3, AD7793_CH_AVDD_MONITOR, (_b), (_sb), 0), \
